...
namespace OpenCVForUnity.UnityUtils
{
    public static partial class Utils
    {
        ...
        /// If the texture format is not RGBA32, BGRA32, RGB24, Alpha8, or R8, the <see href="https://docs.unity3d.com/ScriptReference/Texture2D.SetPixels32.html">Texture2D.SetPixels32</see> and <see href="http://docs.unity3d.com/ScriptReference/Texture2D.GetPixels32.html">Texture2D.GetPixels32</see> methods are used. In such cases, it is recommended to use the <paramref name="pixels32Buffer"/> argument to avoid repeated memory allocations.
        /// </remarks>
        /// <param name="mat">
        ...
        /// The destination Texture2D supports the following formats. (<see href="https://docs.unity3d.com/ScriptReference/Texture2D.SetPixels32.html">Texture2D.SetPixels32</see>)
        /// </param>
        /// <param name="flip">
        ...
        /// Ensure the array is initialized to a length matching the texture’s width * height. (<see href="http://docs.unity3d.com/ScriptReference/Texture2D.GetPixels32.html">Texture2D.GetPixels32</see>)
        /// </param>
        ...
        /// Passing a byte array can help avoid memory allocation each frame. Ensure the array length matches the texture's raw data size. (<see href="https://docs.unity3d.com/ScriptReference/Texture2D.GetRawTextureData.html">Texture2D.GetRawTextureData</see>)
        ...
        /// <param name="pixels32Buffer">
        /// An optional array for receiving pixel data as Color32. Using this array helps avoid memory allocation each frame.
        /// Ensure the array is initialized to a length matching the  texture’s mipmap width * height. (<see href="http://docs.unity3d.com/ScriptReference/Texture2D.GetPixels32.html">Texture2D.GetPixels32</see>)
        /// </param>
        /// <param name="flip">
        /// If <c>true</c>, the Mat is flipped before conversion.
        /// The default is <c>true</c>, as the Mat must be flipped to align with the coordinate system of the destination Texture2D image.
        ...
        /// If the texture format is not RGBA32, BGRA32, RGB24, Alpha8, or R8, the <see href="http://docs.unity3d.com/ScriptReference/Texture2D.GetPixels32.html">Texture2D.GetPixels32</see> methods are used.
        /// </remarks>
        /// <param name="texture2D">
        /// The source Texture2D must have the same size as the destination Mat.
        /// The source Texture2D supports the following formats. (<see href="http://docs.unity3d.com/ScriptReference/Texture2D.GetPixels32.html">Texture2D.GetPixels32</see>)
        /// </param>
        /// <param name="mat">
        ...
        /// <param name="pixels32Buffer">
        /// An optional array for receiving pixel data as Color32. Using this array helps avoid memory allocation each frame.
        /// Ensure the array is initialized to a length matching the  texture’s width * height. (<see href="http://docs.unity3d.com/ScriptReference/WebCamTexture.GetPixels32.html">WebCamTexture.GetPixels32</see>)
        /// </param>
        /// <param name="flip">
        /// If <c>true</c>, the pixel data retrieved from the WebCamTexture is flipped before conversion.
        /// The default is <c>true</c>, as the pixel data must be flipped to align with the coordinate system of the destination Mat.
